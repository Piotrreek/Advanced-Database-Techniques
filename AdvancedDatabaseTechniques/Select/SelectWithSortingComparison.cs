...
[InvocationCount(1)]
public class SelectWithSortingComparison
{
    ...
    [Benchmark]
    public void PostgresSelectWithSorting()
    {
        _npgsqlConnection.Query("SELECT * FROM job ORDER BY salary DESC LIMIT 100");
    }
        
    [Benchmark]
    public void RedisSelectWithSorting()
    {
        _db.Execute("FT.SEARCH", "idx:job", "*", "SORTBY", "Salary", "DESC", "LIMIT", "0", "100");
    }
}
