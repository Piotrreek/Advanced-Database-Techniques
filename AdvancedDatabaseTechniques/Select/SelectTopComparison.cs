...
[InvocationCount(1)]
public class SelectTopComparison
{
    ...
    [Benchmark]
    public void PostgresSelectTop()
    {
        _npgsqlConnection.Query("SELECT * FROM person LIMIT 10");
    }


    [Benchmark]
    public void RedisSelectTop()
    {
        _db.Execute("FT.SEARCH", "idx:person", "*");
    }
}
